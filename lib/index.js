...
const styles = StyleSheet.create({
  ...
  buttonStyle: {
    ...
    justifyContent: 'center',
    borderRadius: ((width + height) / 100) * 5,
    alignItems: 'center'
  },
  buttonText: {
    alignSelf: 'center',
...
const AppButton = Platform.select({
...
export default class LinkedInModal extends React.Component {
  constructor() {
    ...
    this.renderButtonLinkedinText = () => {
      const { linkText } = this.props;
      return (
        <AppButton onPress={this.open}>
    ...
    this.renderButton = () => {
      ...
      if (renderButton) {
        return this.renderButtonLinkedinText();
      }
      return this.renderButtonLinkedinText();
    };
    this.renderClose = () => {
